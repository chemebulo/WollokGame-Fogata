...
class Escenario{ 
    var property mapa      = mapa_comun           // Representa el mapa que tiene el escenario.
    ...
    var property configuradorSiguiente = {}       // Representa al configurador siguiente del escenario.
