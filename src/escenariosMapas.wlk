...
const mapa_cueva_v1 =
    [
        ...
        [_,_,o,o,_,_,_,_,_,o,_,_,_],
        [_,_,_,_,_,_,_,_,_,o,l,_,_],
        [_,l,_,o,o,_,_,_,_,_,_,_,_],
        [_,_,_,_,_,_,_,_,_,_,_,_,_],
...
const mapa_cueva_v2 =
    [
        [_,_,_,_,_,_,_,_,_,_,_,_,_],
        [_,_,_,_,_,_,_,_,_,l,_,_,_],
        [_,_,l,_,_,_,o,_,_,_,o,_,_],
        [_,_,_,_,_,_,_,_,_,_,_,_,_],
        [_,_,_,o,o,_,_,_,_,_,_,_,pc],
        [_,_,l,_,_,_,_,_,_,l,_,_,_],
        [_,_,_,_,_,_,o,_,_,_,o,_,_],
        [_,_,_,_,_,o,o,_,_,_,o,_,_],
...
const mapa_cueva_v3 =
    [
        [_,_,_,_,_,_,_,_,_,_,_,_,_],
        [z,_,_,_,_,_,l,_,_,_,_,_,_],
        [_,_,_,_,l,_,_,_,o,_,_,_,o],
        [_,_,_,_,_,_,_,_,_,_,_,_,_],
        [_,_,l,_,_,o,_,_,_,_,_,_,_],
        [_,_,_,_,_,o,o,_,_,l,_,_,_],
        [_,_,o,_,_,_,_,_,_,_,_,_,_],
        [_,_,_,_,_,_,_,o,o,_,_,_,_],
        [_,_,_,o,_,_,_,_,_,_,_,pc,_]
...
const mapa_cueva_v4 =
    [
        [_,_,_,_,_,_,_,_,_,_,_,z,_],
        [_,_,_,_,_,_,_,_,_,_,_,_,_],
        [_,_,_,_,_,l,_,o,_,_,_,_,_],
        [_,_,_,l,_,l,_,o,_,_,o,_,_],
        [_,_,_,_,_,_,_,o,_,_,o,_,_],
        [_,_,_,o,o,_,o,o,_,o,o,_,_],
        [_,_,_,_,_,_,_,_,_,_,_,_,_],
        [_,_,_,_,_,_,l,_,_,l,l,_,_],
