...
const mapa_entradaCabaña_v1 = 
    [
        ...
        [ _ , _ , _ , _ , _ , _ , _ , _ , _ , _ , _ , _ , _ ],
        [ _ , _ , _ , _ , _ , _ , _ , _ , _ , _ , _ , _ , _ ],
        [ _ , _ , _ , _ , _ , _ , p , p , p , _ , _ , _ , _ ],
        [ _ , z , _ , _ , _ , x ,pg , p , p , _ , _ , _ , _ ],
        [ _ , _ , _ , _ , _ , _ , _ , _ , _ , _ , _ , _ , _ ],
        [ _ , _ , _ , _ , _ , _ , _ , _ , _ , _ , _ , _ , _ ],
        [ _ , _ , _ , _ , _ , _ , _ , _ , _ , _ , _ , _ , _ ],
        [ _ , _ , _ , _ , _ , _ , _ , _ , _ , _ , _ , _ , _ ]
...
const mapa_entradaCueva_v1 =
    [
        [ _ , _ , p , p , p , p , _ , _ , _ , _ , _ , _ , _ ],
        [ _ , _ , p , _ , _ , _ , p , _ , _ , _ , _ , _ , _ ],
        [ _ , _ , p , _ , _ , p , p , _ , _ , _ , _ , _ , _ ],
        [ _ , _ , p , p , p , pc, p , p , _ , _ , _ , _ , _ ],
...
const mapa_estacionamiento_v1 = 
    [
        ...
        [ _ , _ , _ , _ , _ , _ , _ , _ , _ , _ , _ , _ , _ ],
        [ _ , _ , _ , _ , _ , _ , _ , _ , _ , _ , _ , _ , _ ],
        [ _ , _ , p , p , _ , _ , _ , _ , _ , _ , _ , _ , _ ],
        [ _ , _ , p , p , _ , _ , _ , _ , p , p , _ , _ , _ ],
        [ _ , _ , p , s , _ , _ , _ , _ , _ , _ , _ , _ , _ ],
        [ _ , _ , _ , _ , _ , _ , _ , _ , _ , _ , _ , _ , _ ],
        [ _ , _ , _ , _ , _ , _ , _ , _ , _ , _ , _ , _ , _ ],
        [ _ , _ , _ , _ , _ , _ , z , _ , _ , _ , _ , _ , _ ]
    ].reverse()
