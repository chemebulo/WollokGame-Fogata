...
[
        ...
        [_,l,_,_,_,_,_,o,_,_,_,_,_],
        [_,_,l,_,_,_,_,o,o,_,_,_,_],
        [_,_,_,l,_,_,_,_,_,_,_,_,_],
        [_,_,_,_,g,_,_,_,_,_,_,_,z],
        [_,_,_,l,_,_,_,_,_,_,_,_,pc],
        [_,_,l,_,o,_,_,_,_,_,o,_,_],
        [_,l,_,_,o,o,_,_,_,_,o,o,_],
        [l,_,_,_,_,_,_,_,_,_,_,_,_]
