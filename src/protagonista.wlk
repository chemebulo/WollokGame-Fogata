...
object protagonista{
    ...
    const property objetosColision = #{amiga}
    const property objetosParaInteractuar = #{puerta}
  ...
  /*thod interactuar(){
        const objetoEnLugar = game.getObjectsIn(position)
        
        objetoEnLugar.interactuar()
